 ...
 */
/*global jQuery*/
/*jslint white: true, browser: true, devel: true, onevar: true, undef: true, eqeqeq: true, plusplus: true, bitwise: true, regexp: true, newcap: true, immed: true */
(function ($) {
    var managed = {},
        cache = {};
    $.manageAjax = (function () {
    ...
    $.manageAjax._manager.prototype = {
        ...
        _createAjax: function (id, o, origSuc, origCom) {
            ...
            return function () {
                ...
                that.inProgress = that.inProgress + 1;
        ...
        _success: function (context, origFn, data, status, xhr, o) {
            var that = this,
                responseHeaders, parsedHeaders, parseHeaders;
            if (this._isAbort(xhr, status, o)) {
                xhr = null;
                return;
            }
    ...
    $.manageAjax.defaults = {
        ...
        maxRequests: 1,
        cacheResponse: false,
        //time in milliseconds to cache response for. -1 = forever, 1000 = 1 second, etc.
        cacheTTL: -1,
